...
protected:
    ...
    void set_kbd_portamento(float newValue) { QMutexLocker locker(&m_mutex); m_synth.kbd.portamento = newValue; emit controlChanged(); }
    ...
    void set_kbd_transpose(float newValue) { QMutexLocker locker(&m_mutex); m_synth.kbd.transpose = newValue; emit controlChanged(); }
    ...
    void set_vco1_tune(float newValue) { QMutexLocker locker(&m_mutex); m_synth.vco1.tune = newValue; emit controlChanged(); }
    ...
    void set_vco1_detune(float newValue) { QMutexLocker locker(&m_mutex); m_synth.vco1.detune = newValue; emit controlChanged(); }
    ...
    void set_vco2_tune(float newValue) { QMutexLocker locker(&m_mutex); m_synth.vco2.tune = newValue; emit controlChanged(); }
    ...
    void set_vco2_detune(float newValue) { QMutexLocker locker(&m_mutex); m_synth.vco2.detune = newValue; emit controlChanged(); }
    ...
    void set_lfo_freq(float newValue) { QMutexLocker locker(&m_mutex); m_synth.lfo.freq = newValue; emit controlChanged(); }
    ...
    void set_vcf_cutoff(float newValue) { QMutexLocker locker(&m_mutex); m_synth.vcf.cutoff = newValue; emit controlChanged(); }
    ...
    void set_vcf_reso(float newValue) { QMutexLocker locker(&m_mutex); m_synth.vcf.reso = newValue; emit controlChanged(); }
    ...
    void set_hpf_cutoff(float newValue) { QMutexLocker locker(&m_mutex); m_synth.hpf.cutoff = newValue; emit controlChanged(); }
    ...
    void set_vca_gain(float newValue) { QMutexLocker locker(&m_mutex); m_synth.vca.gain = newValue; emit controlChanged(); }
    ...
    void set_ar_attack(float newValue) { QMutexLocker locker(&m_mutex); m_synth.ar.attack = newValue; emit controlChanged(); }
    ...
    void set_ar_release(float newValue) { QMutexLocker locker(&m_mutex); m_synth.ar.release = newValue; emit controlChanged(); }
    ...
    void set_vco1_fm1(float newValue) { QMutexLocker locker(&m_mutex); m_synth.vco1.fm1 = newValue; emit controlChanged(); }
    ...
    void set_vco1_fm2(float newValue) { QMutexLocker locker(&m_mutex); m_synth.vco1.fm2 = newValue; emit controlChanged(); }
    ...
    void set_vco1_pw(float newValue) { QMutexLocker locker(&m_mutex); m_synth.vco1.pw = newValue; emit controlChanged(); }
    ...
    void set_vco1_pwm(float newValue) { QMutexLocker locker(&m_mutex); m_synth.vco1.pwm = newValue; emit controlChanged(); }
    ...
    void set_vco2_fm1(float newValue) { QMutexLocker locker(&m_mutex); m_synth.vco2.fm1 = newValue; emit controlChanged(); }
    ...
    void set_vco2_fm2(float newValue) { QMutexLocker locker(&m_mutex); m_synth.vco2.fm2 = newValue; emit controlChanged(); }
    ...
    void set_vco2_pw(float newValue) { QMutexLocker locker(&m_mutex); m_synth.vco2.pw = newValue; emit controlChanged(); }
    ...
    void set_vco2_pwm(float newValue) { QMutexLocker locker(&m_mutex); m_synth.vco2.pwm = newValue; emit controlChanged(); }
    ...
    void set_sh_vco1(float newValue) { QMutexLocker locker(&m_mutex); m_synth.sh.vco1 = newValue; emit controlChanged(); }
    ...
    void set_sh_noise(float newValue) { QMutexLocker locker(&m_mutex); m_synth.sh.noise = newValue; emit controlChanged(); }
    Q_PROPERTY(float sh_lag READ get_sh_lag WRITE set_sh_lag NOTIFY controlChanged)
    float get_sh_lag() { return m_synth.sh.lag; }
    void set_sh_lag(float newValue) { QMutexLocker locker(&m_mutex); m_synth.sh.lag = newValue; emit controlChanged(); }
    ...
    void set_mix_noise_ring(float newValue) { QMutexLocker locker(&m_mutex); m_synth.mix.noise_ring = newValue; emit controlChanged(); }
    ...
    void set_mix_vco1(float newValue) { QMutexLocker locker(&m_mutex); m_synth.mix.vco1 = newValue; emit controlChanged(); }
    ...
    void set_mix_vco2(float newValue) { QMutexLocker locker(&m_mutex); m_synth.mix.vco2 = newValue; emit controlChanged(); }
    ...
    void set_vcf_mod1(float newValue) { QMutexLocker locker(&m_mutex); m_synth.vcf.mod1 = newValue; emit controlChanged(); }
    ...
    void set_vcf_mod2(float newValue) { QMutexLocker locker(&m_mutex); m_synth.vcf.mod2 = newValue; emit controlChanged(); }
    ...
    void set_vcf_env(float newValue) { QMutexLocker locker(&m_mutex); m_synth.vcf.env = newValue; emit controlChanged(); }
    ...
    void set_vca_env(float newValue) { QMutexLocker locker(&m_mutex); m_synth.vca.env = newValue; emit controlChanged(); }
    ...
    void set_adsr_attack(float newValue) { QMutexLocker locker(&m_mutex); m_synth.adsr.attack = newValue; emit controlChanged(); }
    ...
    void set_adsr_decay(float newValue) { QMutexLocker locker(&m_mutex); m_synth.adsr.decay = newValue; emit controlChanged(); }
    ...
    void set_adsr_sustain(float newValue) { QMutexLocker locker(&m_mutex); m_synth.adsr.sustain = newValue; emit controlChanged(); }
    ...
    void set_adsr_release(float newValue) { QMutexLocker locker(&m_mutex); m_synth.adsr.release = newValue; emit controlChanged(); }
    ...
    void set_vco1_kbd(bool newValue) { QMutexLocker locker(&m_mutex); m_synth.vco1.kbd = newValue; emit controlChanged(); }
    ...
    void set_vco2_sync(bool newValue) { QMutexLocker locker(&m_mutex); m_synth.vco2.sync = newValue; emit controlChanged(); }
    ...
    void set_noise_white(bool newValue) { QMutexLocker locker(&m_mutex); m_synth.noise.white = newValue; emit controlChanged(); }
    ...
    void set_vco1_fm1_is_lfo_sine(bool newValue) { QMutexLocker locker(&m_mutex); m_synth.vco1.fm1_is_lfo_sine = newValue; emit controlChanged(); }
    ...
    void set_vco1_fm2_is_sh_out(bool newValue) { QMutexLocker locker(&m_mutex); m_synth.vco1.fm2_is_sh_out = newValue; emit controlChanged(); }
    ...
    void set_vco1_pwm_is_lfo(bool newValue) { QMutexLocker locker(&m_mutex); m_synth.vco1.pwm_is_lfo = newValue; emit controlChanged(); }
    ...
    void set_vco2_fm1_is_lfo_sine(bool newValue) { QMutexLocker locker(&m_mutex); m_synth.vco2.fm1_is_lfo_sine = newValue; emit controlChanged(); }
    ...
    void set_vco2_fm2_is_sh_out(bool newValue) { QMutexLocker locker(&m_mutex); m_synth.vco2.fm2_is_sh_out = newValue; emit controlChanged(); }
    ...
    void set_vco2_pwm_is_lfo(bool newValue) { QMutexLocker locker(&m_mutex); m_synth.vco2.pwm_is_lfo = newValue; emit controlChanged(); }
    ...
    void set_sh_vco1_saw(bool newValue) { QMutexLocker locker(&m_mutex); m_synth.sh.vco1_saw = newValue; emit controlChanged(); }
    ...
    void set_sh_noise_gen(bool newValue) { QMutexLocker locker(&m_mutex); m_synth.sh.noise_gen = newValue; emit controlChanged(); }
    ...
    void set_sh_lfo_trigger(bool newValue) { QMutexLocker locker(&m_mutex); m_synth.sh.lfo_trigger = newValue; emit controlChanged(); }
    ...
    void set_mix_noise(bool newValue) { QMutexLocker locker(&m_mutex); m_synth.mix.noise = newValue; emit controlChanged(); }
    ...
    void set_mix_vco1_saw(bool newValue) { QMutexLocker locker(&m_mutex); m_synth.mix.vco1_saw = newValue; emit controlChanged(); }
    ...
    void set_mix_vco2_saw(bool newValue) { QMutexLocker locker(&m_mutex); m_synth.mix.vco2_saw = newValue; emit controlChanged(); }
    ...
    void set_vcf_mod1_kbd(bool newValue) { QMutexLocker locker(&m_mutex); m_synth.vcf.mod1_kbd = newValue; emit controlChanged(); }
    ...
    void set_vcf_mod2_sh(bool newValue) { QMutexLocker locker(&m_mutex); m_synth.vcf.mod2_sh = newValue; emit controlChanged(); }
    ...
    void set_vcf_env_adsr(bool newValue) { QMutexLocker locker(&m_mutex); m_synth.vcf.env_adsr = newValue; emit controlChanged(); }
    ...
    void set_vca_env_ar(bool newValue) { QMutexLocker locker(&m_mutex); m_synth.vca.env_ar = newValue; emit controlChanged(); }
    ...
    void set_adsr_kbd_trigger(bool newValue) { QMutexLocker locker(&m_mutex); m_synth.adsr.kbd_trigger = newValue; emit controlChanged(); }
    ...
    void set_adsr_kbd_repeat(bool newValue) { QMutexLocker locker(&m_mutex); m_synth.adsr.kbd_repeat = newValue; emit controlChanged(); }
    ...
    void set_ar_kbd_trigger(bool newValue) { QMutexLocker locker(&m_mutex); m_synth.ar.kbd_trigger = newValue; emit controlChanged(); }
